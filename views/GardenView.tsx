            ...
            <div className="p-8">
              ...
              <div className="flex gap-4">
                <button 
                  ...
                  className="flex-1 bg-botanist text-white px-4 py-3 rounded-full text-xs font-black uppercase tracking-widest hover:bg-botanist-dark transition-colors shadow-lg shadow-botanist/10"
                >
                  Schedule Care
                </button>
                <button 
